 ...
 const comidasFavoritas = [
  ...
  const accesorios = [
    'Destellitos despanpanates',
    'Musiquita bonita',
    'El rey soy yo',
    'Nube para dias tristes o no',
    'Moño rosado divino',
    'Orejas de conejo que hacen sonidos',
    'Peluche abrazable que te abraza',
    'Gafas de rayos X sonrientes',
    'Relojes de arena que no pasan el tiempo',
    'Sistema solar que gira sin parar',
    'Sombrero flotante de burbujas de color',
    'Siempre elegante nunca inelegante',
    'Sombrero Pirata que hace piratas',
